...
public class Trame {
    ...
    /*
     * Pour mettre le syn ack en relative number
     * Il permet de verifier si l'ip et le port sont les meme entre 2 trames
     */
    ...
    /*
     * Pour mettre le syn ack en relative number
     * Il permet de verifier si l'ip et le port sont opposes entre 2 trames
     */
