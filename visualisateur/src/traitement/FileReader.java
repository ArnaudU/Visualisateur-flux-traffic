...
/*
 * Lit un fichier HexDump ASCII et le transforme les octets associe a ce fichier en une ArrayList<ArrayList<String>
 * ArrayList<ArrayList<String> est une liste de trame où les trames contient une liste d'octets
 */
