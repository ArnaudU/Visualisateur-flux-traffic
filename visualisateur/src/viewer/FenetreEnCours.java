...
/*
 * C'est une classe qui traite l'interaction entre l'application et l'utilisateur
 */
public class FenetreEnCours extends FenetreInit{
    ...
    private void addAction(){
        ...
        btnFiltre.addActionListener(e -> {if(table!=null){
    ...
    private void startButton(ActionEvent e) throws IOException, FormatInvalidException, ProtocoleInvalidException, OctetInvalidException {
        ...
        if(!path.isEmpty()){
            ...
            setTxtOutput(table.getTrames().getGraphe());
            txtOutput.setBackground(colorJaunePastel);
        }
        else{
